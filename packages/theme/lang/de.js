...
export default {
  ...
  'Customer': 'Kunde',
  'Vue Storefront Next': 'Vue Storefront Weiter',
  'Search': 'Suche',
  'First name': 'Vorname',
  'Last name': 'Nachname',
  'Street name': 'Straßenname',
  'House_OR_Apartment_number': 'Haus-/Wohnungsnummer',
  'City': 'Stadt',
  'State_OR_Province': 'Bundesland/Provinz',
  'Country': 'Land',
  ...
  'Subtotal price': 'Zwischensummenpreis',
